...
public class ChessGame {
    ...
    private Move parseMove(String moveString) {
        ...
        return new Move(fromX, fromY, toX, toY, board);
    }
    ...
    private boolean validateMove(Move move) {
        ...
        if (!PieceUtils.isOnBoard(move.getFromX(), move.getFromY()) || !PieceUtils.isOnBoard(move.getToX(), move.getToY())) {
            return false;
        }
