...
public class Board {
    ...
    public String toString() {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            result.append(i + 1).append(System.lineSeparator());//result.append(8 - i).append(System.lineSeparator());
        }
    ...
    public boolean movePiece(int fromX, int fromY, int toX, int toY) { // int fromRow, int fromCol, int toRow, int toCol-ra akár ?
